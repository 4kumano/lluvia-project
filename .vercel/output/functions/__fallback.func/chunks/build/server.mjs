import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, useSlots, h, Fragment, ref, inject, Suspense, createApp, reactive, computed, toRaw, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, effectScope, watch, mergeProps, getCurrentScope, toRef, toValue, shallowRef, onScopeDispose, isReadonly, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { m as klona, n as parseURL, o as encodePath, q as decodePath, i as createError$1, r as hasProtocol, s as isScriptProtocol, l as joinURL, w as withQuery, v as defuFn, x as sanitizeStatusCode, y as getContext, $ as $fetch$1, z as baseURL, A as defu, B as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dqt3js7U.mjs')
  }
];
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAppConfig as d, entry_default as default, encodeRoutePath as e, asyncDataDefaults as f, createError as g, navigateTo as n, resolveRouteObject as r, useRouter as u };
